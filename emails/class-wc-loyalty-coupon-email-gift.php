...
class WC_Loyalty_Coupon_Email_Gift extends WC_Email {
	...
	public function __construct() {
		...
		$this->subject        = 'You\'ve Been Gifted a Coupon - ${coupon_amount}';
	...
	public function get_subject() {
		...
		return apply_filters( 'woocommerce_email_subject_' . $this->id, "You've Been Gifted a \${$amount} Coupon from " . $this->get_blogname(), $this->object );
	}
	...
	public function get_content_html() {
		...
		$html .= '<p>A friend has gifted you a <strong>$' . $amount . ' coupon</strong> from ' . esc_html( get_option( 'blogname' ) ) . '!</p>';
		$html .= '<p style="color: #666; font-size: 14px; margin: 15px 0;">That\'s what we call friendship! Your friend thought of you and wanted to share the savings.</p>';
		...
		$html .= '</ul>';
		$html .= '<p style="margin-top: 20px;">Ready to use your gift? Simply apply this coupon code at checkout on your next purchase at ' . esc_html( get_option( 'blogname' ) ) . '!</p>';
	...
	public function get_content_plain() {
		...
		$text = "Great news!\n\n";
		$text .= "A friend has gifted you a \$$amount coupon from " . get_option( 'blogname' ) . "!\n\n";
