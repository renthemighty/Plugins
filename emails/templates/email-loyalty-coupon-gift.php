<?php
/**
 * Email template for gift loyalty coupons
 *
...
do_action( 'woocommerce_email_header', $email_heading, $email ); ?>
	...
	<p><?php _e( 'Great news!', 'wc-loyalty-coupon' ); ?></p>

	<p><?php printf( __( 'A friend has gifted you a <strong>$%s coupon</strong> from %s!', 'wc-loyalty-coupon' ), wc_price( $coupon->get_amount() ), esc_html( get_option( 'blogname' ) ) ); ?></p>

	<p style="color: #666; font-size: 14px; margin: 15px 0;">
		<?php _e( 'That\'s what we call friendship! Your friend thought of you and wanted to share the savings.', 'wc-loyalty-coupon' ); ?>
	</p>

	<h2 style="color: #0073aa; margin-top: 20px; margin-bottom: 10px;"><?php _e( 'Your Coupon Code', 'wc-loyalty-coupon' ); ?></h2>

	<div style="background: #f5f5f5; padding: 15px; border-left: 4px solid #28a745; border-radius: 4px; margin: 20px 0;">
		<p style="font-size: 18px; font-weight: bold; color: #28a745; margin: 0; letter-spacing: 2px;">
	...
	<p style="margin-top: 20px;">
		<?php printf(
			__( 'Ready to use your gift? Simply apply this coupon code at checkout on your next purchase at %s!', 'wc-loyalty-coupon' ),
